...
export class Palette {
    static colors = [
        ...
        new Color(0x7e,0x7e,0x7e,0xff),
        new Color(0xbe,0xbe,0xbe,0xff),
        new Color(0xff,0xff,0xff,0xff),
        new Color(0x7e,0x00,0x00,0xff),
        new Color(0xfe,0x00,0x00,0xff),
        new Color(0x04,0x7e,0x00,0xff),
        new Color(0x06,0xff,0x04,0xff),
        new Color(0x7e,0x7e,0x00,0xff),
        new Color(0xff,0xff,0x04,0xff),
        new Color(0x00,0x00,0x7e,0xff),
        new Color(0x00,0x00,0xff,0xff),
        new Color(0x7e,0x00,0x7e,0xff),
        new Color(0xfe,0x00,0xff,0xff),
        new Color(0x04,0x7e,0x7e,0xff),
        new Color(0x06,0xff,0xff,0xff),*/
